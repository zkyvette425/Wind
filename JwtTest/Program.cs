...
try
{
    ...
    // 创建简单的空Logger (使用Microsoft.Extensions.Logging.Abstractions)
    ILogger<JwtService> logger = Microsoft.Extensions.Logging.Abstractions.NullLogger<JwtService>.Instance;
    
    // 创建JWT服务
    var jwtService = new JwtService(options, logger);
