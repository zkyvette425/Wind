...
echo 📈 Redis服务状态:
echo.
docker exec wind-redis-test redis-cli -a windgame123 info server | findstr "redis_version"
docker exec wind-redis-test redis-cli -a windgame123 info memory | findstr "used_memory_human"
docker exec wind-redis-test redis-cli -a windgame123 info stats | findstr "total_commands_processed"
